/**
 * public: declaração que "exporta" e permite que a classe/método/variável seja
 * importada/reutilizada em outras classes/objetos
...
public class HelloWorld { // Aqui é criada a classe HelloWorld
     ...
     * exceto pelo uso de @Override
     * void: modo protegido de um método, o qual não retornará qualquer valor
     * main: nome do método "executor"
     * ( (abre parênteses): serve para declarar o início das declarações de
     * parâmetros de um método/função
     * ) (fecha parênteses): serve para declarar o fim das declarações de parâmetros
     * de um método/função
     * 
     * @param args
