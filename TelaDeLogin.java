...
public class TelaDeLogin extends JFrame {
    ...
    public TelaDeLogin()
    {
            ...
            new ActionListener() {
                ...
                public void actionPerformed(ActionEvent event) {
                    ...
                    if (rstSqlLogin.next()) {
                        ...
                        lblNotificacoes.setText(setHtmlFormat("Não foi possível encontrar o login e/ou senha digitados! Por favor, verifique e tente novamente." ));
                    }
                    stmSqlLogin.close();
                } catch (Exception e) {
                    lblNotificacoes.setText(setHtmlFormat("Não foi possível encontrar login e/ ou senha digitados/informados!Por favor, verifique e tente novamente. Veja o erro: " + e));
        ...
        setSize(150, 200); // Ajuste o tamanho da janela conforme necessário
        setVisible(true);
    }
